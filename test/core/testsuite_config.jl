...
@testset "normalize_runner_args" begin
    include_extended, passthrough_args = TestsuiteConfig.normalize_runner_args(["extended", "--jobs=1"])
...
@testset "build_testsuite" begin
    ...
    @test !haskey(core_suite, "extended/cxxm_basic")
    ...
    @test haskey(extended_suite, "extended/cxxm_basic")
end
